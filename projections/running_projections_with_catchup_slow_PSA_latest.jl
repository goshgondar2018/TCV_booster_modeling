...
@everywhere function typhoid_model_projections!(du, u, p, t) 
    ...
    # xalculate the total intended vaccination rate
...
for archetype in 1:3
    ...
    slow_age_stratified_cases_list = [result[10] for result in archetype_results_with_campaign]  
    ...
    slow_age_stratified_cases_with_campaign = vcat(slow_age_stratified_cases_list...)  

    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_total_cases_with_campaign_latest.csv", slow_total_cases_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_pediatric_cases_with_campaign_latest.csv", slow_pediatric_cases_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_adult_cases_with_campaign_latest.csv", slow_adult_cases_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_incidence_with_campaign_latest.csv", slow_incidence_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_population_with_campaign_latest.csv", slow_population_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_total_doses_with_campaign_latest.csv", slow_total_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_routine_doses_with_campaign_latest.csv", slow_routine_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_booster_doses_with_campaign_latest.csv", slow_booster_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_campaign_doses_with_campaign_latest.csv", slow_campaign_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_slow_waning_age_stratified_cases_with_campaign_latest.csv", slow_age_stratified_cases_with_campaign)  
end
