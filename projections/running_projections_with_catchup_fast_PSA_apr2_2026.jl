...
for archetype in 1:3
    ...
    fast_age_stratified_cases_list = [result[10] for result in archetype_results_with_campaign]  # NEW
    ...
    fast_age_stratified_cases_with_campaign = vcat(fast_age_stratified_cases_list...)  # NEW

    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_total_cases_with_campaign_apr2.csv", fast_total_cases_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_pediatric_cases_with_campaign_apr2.csv", fast_pediatric_cases_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_adult_cases_with_campaign_apr2.csv", fast_adult_cases_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_incidence_with_campaign_apr2.csv", fast_incidence_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_population_with_campaign_apr2.csv", fast_population_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_total_doses_with_campaign_apr2.csv", fast_total_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_routine_doses_with_campaign_apr2.csv", fast_routine_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_booster_doses_with_campaign_apr2.csv", fast_booster_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_campaign_doses_with_campaign_apr2.csv", fast_campaign_doses_with_campaign)
    CSV.write("./projections_output_check/archetype$(archetype)_fast_waning_age_stratified_cases_with_campaign_apr2.csv", fast_age_stratified_cases_with_campaign)  # NEW
end