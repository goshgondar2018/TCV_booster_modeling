...
for archetype in 1:3
    ...
    slow_total_cases_list = [result[1] for result in archetype_results_no_campaign]
    slow_pediatric_cases_list = [result[2] for result in archetype_results_no_campaign]
    slow_adult_cases_list = [result[3] for result in archetype_results_no_campaign]
    slow_incidence_list = [result[4] for result in archetype_results_no_campaign]
    slow_population_list = [result[5] for result in archetype_results_no_campaign]
    slow_total_doses_list = [result[6] for result in archetype_results_no_campaign]
    slow_routine_doses_list = [result[7] for result in archetype_results_no_campaign]
    ...
    slow_incidence_no_campaign = vcat(slow_incidence_list...)
    slow_population_no_campaign = vcat(slow_population_list...)
    slow_total_doses_no_campaign = vcat(slow_total_doses_list...)
    slow_routine_doses_no_campaign = vcat(slow_routine_doses_list...)
    ...
    CSV.write("./projections_output_jun1/archetype$(archetype)_slow_waning_incidence_no_campaign_jun1.csv", slow_incidence_no_campaign)
    CSV.write("./projections_output_jun1/archetype$(archetype)_slow_waning_population_no_campaign_jun1.csv", slow_population_no_campaign)
    CSV.write("./projections_output_jun1/archetype$(archetype)_slow_waning_total_doses_no_campaign_jun1.csv", slow_total_doses_no_campaign)
    CSV.write("./projections_output_jun1/archetype$(archetype)_slow_waning_routine_doses_no_campaign_jun1.csv", slow_routine_doses_no_campaign)
    CSV.write("./projections_output_jun1/archetype$(archetype)_slow_waning_booster_doses_no_campaign_jun1.csv", slow_booster_doses_no_campaign)
    CSV.write("./projections_output_jun1/archetype$(archetype)_slow_waning_age_stratified_cases_no_campaign_jun1.csv", slow_age_stratified_cases_no_campaign) 
